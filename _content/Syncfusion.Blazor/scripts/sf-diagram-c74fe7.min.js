...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/sf-diagram.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./bundles/sf-diagram.js":
/*!*******************************!*\
  !*** ./bundles/sf-diagram.js ***!
  \*******************************/
/*! no exports provided */
...
/* harmony import */ var _modules_sf_diagram_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/sf-diagram.js */ "./modules/sf-diagram.js");
/* harmony import */ var _modules_sf_diagram_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_sf_diagram_js__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./modules/sf-diagram.js":
/*!*******************************!*\
  !*** ./modules/sf-diagram.js ***!
  \*******************************/
...
window.sfBlazor.DiagramWasm = function () {
  'use strict';
  /**
  ...
  function () {
    function InitDraggable(parent, symbolPaletteInstance) {
      ...
      this.helper = function (e) {
        ...
        var symbolSelectedClass = "e-symbol-selected";
        var accordianControl = "e-control e-accordion";
        var symbolHover = "e-symbol-hover"; //helperElement

        var helperElement = "helperElement";
        var target = _this.draggable.currentStateTarget; //Used to check and remove the selected CSS class names starts here
  ...
  var diagram = {
    ...
    createMeasureElements: function createMeasureElements(isZoomValue, layerList, width, height) {
    ...
    updateInnerLayerSize: function updateInnerLayerSize(layerList, width, height, left, top, eventValue) {
      ...
      return this.onChangeScrollValues(document.getElementById(layerList[layerList.length - 1]), left, top, eventValue);
    },
    ...
    textEdit: function textEdit(annotation, centerPoint, nodeBounds, transform, canZoomTextEdit, annottaionId) {
      ...
      var bounds = this.measureHtmlText(annotation.style, text, undefined, undefined, 90);
    ...
    invokeDiagramEvents: function invokeDiagramEvents(e, component) {
      ...
      if (!editTextBoxDiv && (e.type == "mousemove" && !eventStarted || e.type != "mousemove" || !inAction)) {
        if (e.type == "mousemove" && inAction && isZoomPan) {
          eventStarted = true;
      ...
      if (e.type == "mouseup" && !this[textBoxDiv]) {
